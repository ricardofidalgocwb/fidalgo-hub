...
A guarda cobre Gold v1.1, Quiz D1 (sem ✅ no enunciado), ☐ do checklist, slot A.8 Commons (≥100 KB; caixa 8/12 AUSENTE), CTA sem NAP/WhatsApp, e bans (Theodoro / Diogo / CPF / OS viva).
