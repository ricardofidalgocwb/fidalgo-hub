...
A guarda cobre Gold v1.1, Quiz D1 (sem ✅ no enunciado), ☐ do checklist, slot A.8 Drive par dínamo+alt (heritagestocks 443360 · `113903021C` · appletreekit 141153 · `55A kit`; Drive IDs no HTML/README/SOURCES; Commons secundário) + caixa 12 CIP1 + caixa 8 appletreeauto 61–66 (Acervo) (≥100 KB; sem CIP1 caixa 8), CTA sem NAP/WhatsApp, e bans (Theodoro / Diogo / CPF / OS viva).
