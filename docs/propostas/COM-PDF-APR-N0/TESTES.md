...
**8 testes** da guarda original cobrem Gold / Quiz / bans (Gold v1.1, Quiz D1 sem ✅ no enunciado, PII/nomes/Type 3). O ficheiro inclui COS P0 + fichas N0-H1 / N0-H2 / N0-H3 + checklist ☐ + slot A.8 Commons (≥100 KB) com caixa 8/12 ainda AUSENTE + CTA didático. Não publicar. Não mover `tests/test_com_pdf_apr_n0.py` para dentro deste pacote.
