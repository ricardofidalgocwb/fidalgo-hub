...
**8 testes** da guarda original cobrem Gold / Quiz / bans (Gold v1.1, Quiz D1 sem ✅ no enunciado, PII/nomes/Type 3). O ficheiro inclui COS P0 + fichas N0-H1 / N0-H2 / N0-H3 + checklist ☐ + slot A.8 Drive par dínamo+alt (443360 / 141153; heritagestocks `113903021C` · appletreekit `55A kit`; Drive IDs no HTML/README/SOURCES; Commons secundário) + caixa 12 CIP1 + caixa 8 appletreeauto 61–66 (Acervo) (≥100 KB; sem CIP1 caixa 8) + CTA didático. Não publicar. Não mover `tests/test_com_pdf_apr_n0.py` para dentro deste pacote.
