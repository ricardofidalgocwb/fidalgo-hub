...
Same structure as EF. Do not invent a fourth door.
...
Before/after **elétrico**, 4:3 crops.

Do **not** name any live OS, client, plate, or vehicle identity. Do not invent metrics, counts, or kVA-style tables. Placeholders are allowed until Comunicação supplies anonymized pairs.
